...
>
> IBAN is **no longer a member field**. It belongs to the **mandate record** ([ADR-0006](../../adr/0006-sepa-mandate-reference-strategy.md) amended, [#164](https://github.com/dgloeckner/clubbar/issues/164)) — one record carrying reference, IBAN and signature date, at most one active per member.
>
