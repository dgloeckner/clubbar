...
The Member Bar System collects payments via SEPA Direct Debit. Members consume products at the terminal, and their outstanding balance is periodically settled via SEPA collection. For SEPA collections to succeed, each member must have:
