...
class BackupSealedBoxTest extends TestCase
{
    ...
    {
        $archive = BackupSealedBox::seal('-- SQL dump --', [$this->recipient('kassenwart', $this->pkA)]);
    ...
    public function test_sealing_never_needs_a_private_key(): void
    {
        ...
        $archive = BackupSealedBox::seal($payload, [$this->recipient('kassenwart', $this->pkA)]);
    ...
    public function test_either_recipient_can_open_a_two_recipient_archive(): void
    {
        $archive = BackupSealedBox::seal('shared', [
            $this->recipient('kassenwart', $this->pkA),
    ...
    {
        $archive = BackupSealedBox::seal('x', [$this->recipient('kassenwart', $this->pkA)]);
    ...
    public function test_the_header_names_its_recipients_so_a_holder_knows_which_key_to_fetch(): void
    {
        ...
        $this->assertSame(
            ...
            'The fingerprint is what lets a treasurer match an archive to a key in the safe.'
        );
    }
    ...
    {
        $archive = BackupSealedBox::seal('trustworthy', [$this->recipient('kassenwart', $this->pkA)]);
