...
class DashboardRepositoryTest extends DatabaseTestCase
{
    ...
    public function test_findMembersNearCreditLimit_lists_only_tabs_that_reached_the_threshold(): void
    {
        ...
        $ids = $this->idsOf($this->repository->findMembersNearCreditLimit(10_000, 80, 50));
    ...
    public function test_findMembersNearCreditLimit_sums_the_whole_tab_not_the_single_purchase(): void
    {
        ...
        $row = $this->rowFor($member, $this->repository->findMembersNearCreditLimit(10_000, 80, 50));
    ...
    public function test_findMembersNearCreditLimit_forgets_a_tab_that_has_been_settled(): void
    {
        ...
        $this->assertContains($member, $this->idsOf($this->repository->findMembersNearCreditLimit(10_000, 80, 50)));

        $this->settle($member, $transaction, 9_500);

        $this->assertNotContains($member, $this->idsOf($this->repository->findMembersNearCreditLimit(10_000, 80, 50)));
    }
    ...
    public function test_findMembersNearCreditLimit_puts_the_biggest_tab_first_and_honours_the_limit(): void
    {
        ...
        $this->assertCount(1, $this->repository->findMembersNearCreditLimit(20_000, 100, 1));

        $ids = $this->idsOf($this->repository->findMembersNearCreditLimit(10_000, 80, 500));
    ...
    {
        $before = $this->repository->countMembersNearCreditLimit(10_000, 80);
        ...
        $this->assertSame($before + 2, $this->repository->countMembersNearCreditLimit(10_000, 80));
    }
    ...
    public function test_a_raised_override_takes_a_member_off_the_list(): void
    {
        ...
        $this->assertContains($member, $this->idsOf($this->repository->findMembersNearCreditLimit(10_000, 80, 500)));

        // 9,000 is 45 % of 20,000 — nowhere near the band, and the terminal is
        // still serving them.
        $this->setOverride($member, 20_000);

        $this->assertNotContains($member, $this->idsOf($this->repository->findMembersNearCreditLimit(10_000, 80, 500)));
    }
    ...
    public function test_a_member_with_no_ceiling_never_appears_however_large_the_tab(): void
    {
        ...
        $this->assertNotContains($member, $this->idsOf($this->repository->findMembersNearCreditLimit(10_000, 80, 500)));
        $this->assertNotContains($member, $this->idsOf($this->repository->findMembersNearCreditLimit(0, 80, 500)));
    }
    ...
    public function test_an_override_still_counts_when_the_club_default_is_off(): void
    {
        ...
        $ids = $this->idsOf($this->repository->findMembersNearCreditLimit(0, 80, 500));
    ...
    public function test_the_band_boundary_is_the_same_whole_cent_the_terminal_uses(): void
    {
        ...
        $ids = $this->idsOf($this->repository->findMembersNearCreditLimit(10_000, 70, 500));
    ...
    public function test_each_row_carries_the_ceiling_it_was_measured_against(): void
    {
        ...
        $rows = $this->repository->findMembersNearCreditLimit(10_000, 80, 500);
