...
/**
 * Admin Users Module Route Aggregator
 *
 * Aggregates all route files for the Admin Users module.
...
require base_path('app/Http/Modules/AdminUsers/routes/admin.php');
