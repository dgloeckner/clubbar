...
enum AuditAction: string
{
    ...
    // IBAN encryption key lifecycle (ADR-0035). The private key never touches
    ...
    /** A bulk decryption happened: pain.008 built from sealed IBANs (ADR-0035). */
    case SEPA_EXPORT = 'sepa_export';
    /** Privileged full-IBAN display — the exceptional revision case (ADR-0035). */
