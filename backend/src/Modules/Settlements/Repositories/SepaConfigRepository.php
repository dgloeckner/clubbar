...
class SepaConfigRepository
{
    ...
    {
        $allowed = ['creditor_id', 'creditor_name', 'creditor_iban', 'creditor_address_street', 'creditor_address_city', 'creditor_address_country', 'payment_reference_prefix', 'mandate_template_url', 'mandate_reference_prefix'];
