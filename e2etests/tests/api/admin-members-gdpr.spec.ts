...
test.describe('Admin Members GDPR Endpoints', () => {
  // GDPR Export
  test('POST /api/admin/members/{id}/export returns member export data', async ({ request }) => {
    const response = await request.post('/api/admin/members/123e4567-e89b-12d3-a456-426614174000/export');
  ...
  test('POST /api/admin/members/{id}/export includes member details', async ({ request }) => {
    const response = await request.post('/api/admin/members/123e4567-e89b-12d3-a456-426614174000/export');
  ...
  test('POST /api/admin/members/{id}/export returns 404 for non-existent member', async ({ request }) => {
    const response = await request.post('/api/admin/members/nonexistent-id/export');
  ...
  test('POST /api/admin/members/{id}/export returns JSON content type', async ({ request }) => {
    const response = await request.post('/api/admin/members/123e4567-e89b-12d3-a456-426614174000/export');
  ...
  // GDPR Anonymization
  test('POST /api/admin/members/{id}/anonymize anonymizes member data', async ({ request }) => {
    const response = await request.post('/api/admin/members/223e4567-e89b-12d3-a456-426614174001/anonymize');
  ...
  test('POST /api/admin/members/{id}/anonymize preserves original timestamps', async ({ request }) => {
    const response = await request.post('/api/admin/members/223e4567-e89b-12d3-a456-426614174001/anonymize');
  ...
  test('POST /api/admin/members/{id}/anonymize preserves language preference', async ({ request }) => {
    const response = await request.post('/api/admin/members/223e4567-e89b-12d3-a456-426614174001/anonymize');
  ...
  test('POST /api/admin/members/{id}/anonymize returns 404 for non-existent member', async ({ request }) => {
    const response = await request.post('/api/admin/members/nonexistent-id/anonymize');
  ...
  test('POST /api/admin/members/{id}/anonymize returns JSON content type', async ({ request }) => {
    const response = await request.post('/api/admin/members/223e4567-e89b-12d3-a456-426614174001/anonymize');
  ...
  test('GDPR endpoints validate member existence before processing', async ({ request }) => {
    // Try to export non-existent member
    const exportResponse = await request.post('/api/admin/members/invalid-member-id/export');
    expect(exportResponse.status()).toBe(404);

    // Try to anonymize non-existent member
    const anonResponse = await request.post('/api/admin/members/invalid-member-id/anonymize');
    expect(anonResponse.status()).toBe(404);
  });

  test('GDPR export and anonymize operations are atomic', async ({ request }) => {
    const memberId = '123e4567-e89b-12d3-a456-426614174000';

    // Export first
    const exportResponse = await request.post(`/api/admin/members/${memberId}/export`);
    ...
    // Then anonymize
    const anonResponse = await request.post(`/api/admin/members/${memberId}/anonymize`);
