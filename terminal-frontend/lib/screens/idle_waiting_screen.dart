...
class _IdleWaitingScreenState extends State<IdleWaitingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Center(
        // Nothing here is meant to be scrolled through — the ScrollView only
        // absorbs a viewport shorter than the content so it never overflows.
        // `KioskScrollBehavior`'s always-visible thumb is for genuine lists
        // (e.g. the cart); on this fixed splash screen it would just paint a
        // stray scrollbar.
