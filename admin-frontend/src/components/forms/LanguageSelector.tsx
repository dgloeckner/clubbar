          ...
          <div style={{ padding: 6 }}>
            ...
            <button
              ...
              style={{
                ...
                gap: 10,
                padding: '10px 12px',
                background: value === 'de' ? theme.activeTint.primary : 'transparent',
                border: 'none',
                borderRadius: 8,
                color: value === 'de' ? theme.colors.semantic.primary : tableColors.cellText,
                fontSize: 14,
                cursor: 'pointer',
                textAlign: 'left',
                transition: 'all 0.15s',
            ...
            >
              <span style={{ color: value === 'de' ? theme.colors.semantic.primary : theme.colors.text.muted, fontWeight: 500 }}>●</span>
            ...
            <button
              ...
              style={{
                ...
                gap: 10,
                padding: '10px 12px',
                background: value === 'en' ? theme.activeTint.primary : 'transparent',
                border: 'none',
                borderRadius: 8,
                color: value === 'en' ? theme.colors.semantic.primary : tableColors.cellText,
                fontSize: 14,
                cursor: 'pointer',
                textAlign: 'left',
                transition: 'all 0.15s',
            ...
            >
              <span style={{ color: value === 'en' ? theme.colors.semantic.primary : theme.colors.text.muted, fontWeight: 500 }}>●</span>
