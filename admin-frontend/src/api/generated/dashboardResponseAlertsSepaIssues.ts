 ...
 */
import type { DashboardResponseAlertsSepaIssuesSeverity } from './dashboardResponseAlertsSepaIssuesSeverity';

export type DashboardResponseAlertsSepaIssues = {
  /** Number of members with incomplete SEPA data */
  count?: number;
  /** - none: 0 members with issues
- warning: 1-5 members with issues
- error: 6+ members with issues
 */
  severity?: DashboardResponseAlertsSepaIssuesSeverity;
