 ...
 * Type of GDPR export
 */
export type ExportMemberDataBodyExportType = typeof ExportMemberDataBodyExportType[keyof typeof ExportMemberDataBodyExportType];


export const ExportMemberDataBodyExportType = {
