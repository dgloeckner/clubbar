 ...
 */
export type DashboardResponseAlertsJugendschutzViolationSeverity = typeof DashboardResponseAlertsJugendschutzViolationSeverity[keyof typeof DashboardResponseAlertsJugendschutzViolationSeverity];


export const DashboardResponseAlertsJugendschutzViolationSeverity = {
  none: 'none',
  error: 'error',
} as const;
