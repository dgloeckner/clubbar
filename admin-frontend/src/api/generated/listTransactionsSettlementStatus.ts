...
export type ListTransactionsSettlementStatus = typeof ListTransactionsSettlementStatus[keyof typeof ListTransactionsSettlementStatus];


export const ListTransactionsSettlementStatus = {
  open: 'open',
  settled: 'settled',
} as const;
