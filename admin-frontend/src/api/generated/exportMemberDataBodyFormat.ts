 ...
 * Export format
 */
export type ExportMemberDataBodyFormat = typeof ExportMemberDataBodyFormat[keyof typeof ExportMemberDataBodyFormat];


export const ExportMemberDataBodyFormat = {
  json: 'json',
  pdf: 'pdf',
} as const;
