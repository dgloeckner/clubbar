...
import type { SecurityReportStatus } from './securityReportStatus';
import type { SecurityReportSummary } from './securityReportSummary';

export interface SecurityReport {
  generated_at: string;
  /** The worst row in the report; an `unknown` row counts as a warning */
