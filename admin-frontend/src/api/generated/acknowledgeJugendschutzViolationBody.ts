...
export type AcknowledgeJugendschutzViolationBody = {
  /**
   * Optional free text — what was done about it. Never required:
a mandatory field on a dismissal becomes "." and teaches
people to write nothing true.
