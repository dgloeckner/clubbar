 ...
 */
export type DashboardResponseAlertsEncryptionKeySeverity = typeof DashboardResponseAlertsEncryptionKeySeverity[keyof typeof DashboardResponseAlertsEncryptionKeySeverity];


export const DashboardResponseAlertsEncryptionKeySeverity = {
  none: 'none',
  warning: 'warning',
  error: 'error',
} as const;
