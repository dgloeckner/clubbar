 ...
 */
export type SchedulerStatusDeclaredInterval = typeof SchedulerStatusDeclaredInterval[keyof typeof SchedulerStatusDeclaredInterval];


export const SchedulerStatusDeclaredInterval = {
  hourly: 'hourly',
  daily: 'daily',
} as const;
