 ...
 */
import type { DashboardResponseSystemStatusDatabaseHealth } from './dashboardResponseSystemStatusDatabaseHealth';

/**
 * High-level system status indicators
 */
export type DashboardResponseSystemStatus = {
  /**
   * Last settlement creation timestamp
   * @nullable
   */
  last_settlement_date?: string | null;
  /** Count of non-cancelled settlements */
  ...
  database_health?: DashboardResponseSystemStatusDatabaseHealth;
};
