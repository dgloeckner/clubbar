...
**Use Case**: UC-A81, UC-DSGVO-06

Sensitive data is masked in the log entries.
...
const listAuditLog = (
 ...
 options?: SecondParameter<typeof customInstance<ListAuditLog200>>,) => {
  ...
  return {listAuditLog}};
export type ListAuditLogResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getAuditLog>['listAuditLog']>>>
