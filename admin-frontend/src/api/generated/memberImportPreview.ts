 ...
 */
import type { MemberImportPreviewPreviewItem } from './memberImportPreviewPreviewItem';
import type { MemberImportPreviewSummary } from './memberImportPreviewSummary';

export interface MemberImportPreview {
  /** ID to use for confirmation */
  import_id?: string;
  preview?: MemberImportPreviewPreviewItem[];
