 ...
 */
import type { ExportMemberDataBodyExportType } from './exportMemberDataBodyExportType';
import type { ExportMemberDataBodyFormat } from './exportMemberDataBodyFormat';

export type ExportMemberDataBody = {
  /** Export format */
  format: ExportMemberDataBodyFormat;
  /** Type of GDPR export */
  export_type?: ExportMemberDataBodyExportType;
};
