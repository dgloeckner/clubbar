 ...
 */
import type { GdprExportCurrentBalance } from './gdprExportCurrentBalance';
import type { GdprExportExportInfo } from './gdprExportExportInfo';
import type { GdprExportPersonalData } from './gdprExportPersonalData';
import type { GdprExportSettlementsItem } from './gdprExportSettlementsItem';
import type { GdprExportTransactionsItem } from './gdprExportTransactionsItem';

/**
 * GDPR data export (Art. 15 / Art. 20)
 */
export interface GdprExport {
  export_info?: GdprExportExportInfo;
  personal_data?: GdprExportPersonalData;
  transactions?: GdprExportTransactionsItem[];
  settlements?: GdprExportSettlementsItem[];
  current_balance?: GdprExportCurrentBalance;
}
