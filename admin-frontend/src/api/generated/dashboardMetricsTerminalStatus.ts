...
export type DashboardMetricsTerminalStatus = typeof DashboardMetricsTerminalStatus[keyof typeof DashboardMetricsTerminalStatus];


export const DashboardMetricsTerminalStatus = {
  online: 'online',
  offline: 'offline',
  unknown: 'unknown',
} as const;
