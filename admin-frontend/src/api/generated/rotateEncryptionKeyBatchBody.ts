...
export type RotateEncryptionKeyBatchBody = StepUpCredentials & {
  /** The 32-byte private key of the key being rotated away
from, base64-encoded. Never persisted server-side.
 */
  private_key: string;
};
