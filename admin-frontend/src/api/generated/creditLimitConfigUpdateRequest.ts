...
export interface CreditLimitConfigUpdateRequest {
  /**
     * `0` sets "no ceiling". A negative value is rejected rather than
     * read as unlimited — it would pass the same `<= 0` test by accident.
     * @minimum 0
     * @maximum 10000000
     */
