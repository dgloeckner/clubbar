 ...
 * @nullable
 */
export type ReversalCandidateReversedReason = typeof ReversalCandidateReversedReason[keyof typeof ReversalCandidateReversedReason] | null;


export const ReversalCandidateReversedReason = {
