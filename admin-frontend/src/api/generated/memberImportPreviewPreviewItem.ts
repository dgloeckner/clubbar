 ...
 */
import type { MemberImportPreviewPreviewItemData } from './memberImportPreviewPreviewItemData';
import type { MemberImportPreviewPreviewItemStatus } from './memberImportPreviewPreviewItemStatus';

export type MemberImportPreviewPreviewItem = {
  row?: number;
  status?: MemberImportPreviewPreviewItemStatus;
  data?: MemberImportPreviewPreviewItemData;
  errors?: string[];
};
