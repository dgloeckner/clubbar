...
export type MemberTransactionHistorySettlementsItemType = typeof MemberTransactionHistorySettlementsItemType[keyof typeof MemberTransactionHistorySettlementsItemType];


export const MemberTransactionHistorySettlementsItemType = {
  sepa: 'sepa',
  manual: 'manual',
} as const;
