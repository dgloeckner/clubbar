...
export type MailConfigUpdateRequestHeaderStyle = typeof MailConfigUpdateRequestHeaderStyle[keyof typeof MailConfigUpdateRequestHeaderStyle];


export const MailConfigUpdateRequestHeaderStyle = {
  red: 'red',
  petrol: 'petrol',
  paper: 'paper',
} as const;
