 ...
 */
export type DashboardResponseSystemStatusDatabaseHealth = typeof DashboardResponseSystemStatusDatabaseHealth[keyof typeof DashboardResponseSystemStatusDatabaseHealth];


export const DashboardResponseSystemStatusDatabaseHealth = {
  ok: 'ok',
} as const;
