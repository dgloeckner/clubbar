 ...
 */
import type { MandateMissing } from './mandateMissing';

export type ListMembersWithoutMandate200 = {
  items?: MandateMissing[];
  /** Sum of what these members owe — money the club is owed
and currently cannot collect. A different figure from the
credit total (owed out) and the held total (owed in,
temporarily skipped).
 */
  total_uncollectable_cents?: number;
};
