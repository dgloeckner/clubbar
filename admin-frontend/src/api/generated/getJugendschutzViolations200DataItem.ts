...
export type GetJugendschutzViolations200DataItem = {
  /** The `audit_log.id`, and the acknowledgement key */
  id?: number;
  /** The sale this violation names */
  transaction_id?: string;
  /** The age the drink required at the time */
  min_age?: number;
