...
import type { DashboardResponseTerminalStatusItem } from './dashboardResponseTerminalStatusItem';

/**
 * Complete dashboard response with aggregated metrics and system data
 */
export interface DashboardResponse {
  /** Business metrics aggregated from all modules */
  metrics?: DashboardResponseMetrics;
  /** Last 10 transactions ordered by creation time */
  recent_transactions?: DashboardResponseRecentTransactionsItem[];
  /** Status of all terminals with connectivity information */
  terminal_status?: DashboardResponseTerminalStatusItem[];
