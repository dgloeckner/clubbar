...
export type CronSecretRotated = MailConfig & {
  /** The new secret, in the clear. Shown exactly once — only its
SHA-256 hash is persisted, and this field never appears in any
other response.
 */
  cron_secret?: string;
  message?: string;
