 ...
 */
import type { ListNotificationsOrder } from './listNotificationsOrder';
import type { ListNotificationsSort } from './listNotificationsSort';
...
status?: MailStatus;
/**
 * Narrow to one settlement, key or terminal.
 */
subject_id?: string;
/**
 * Matches the snapshot recipient address, or the member's name.
 */
search?: string;
sort?: ListNotificationsSort;
order?: ListNotificationsOrder;
};
