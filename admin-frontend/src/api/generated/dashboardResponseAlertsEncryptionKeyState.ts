 ...
 */
export type DashboardResponseAlertsEncryptionKeyState = typeof DashboardResponseAlertsEncryptionKeyState[keyof typeof DashboardResponseAlertsEncryptionKeyState];


export const DashboardResponseAlertsEncryptionKeyState = {
  missing: 'missing',
  ok: 'ok',
  info: 'info',
  warning: 'warning',
