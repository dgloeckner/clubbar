 ...
 */
export type EncryptionKeyLifecycleState = typeof EncryptionKeyLifecycleState[keyof typeof EncryptionKeyLifecycleState];


export const EncryptionKeyLifecycleState = {
  ok: 'ok',
  info: 'info',
  warning: 'warning',
  critical: 'critical',
