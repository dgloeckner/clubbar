...
| Condition | Status |
|---|---|
| Frontier empty | ❌ one open: [onboarding + Datenschutz](https://github.com/dgloeckner/ruderbar/issues/175) |
...
| 4 | [Sync contract](https://github.com/dgloeckner/ruderbar/issues/82) · [field authority](https://github.com/dgloeckner/ruderbar/issues/79) · **[`sepa_invalid` removal](https://github.com/dgloeckner/ruderbar/issues/162)** · [idempotency tests](https://github.com/dgloeckner/ruderbar/issues/99) | Phase 0 |
...
| [#118 repository bypasses](https://github.com/dgloeckner/ruderbar/issues/118) | `LoginAttemptsRepository` half folds into [#78](https://github.com/dgloeckner/ruderbar/issues/78) |
