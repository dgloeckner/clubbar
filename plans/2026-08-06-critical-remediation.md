...
| [Settlement reversal](https://github.com/dgloeckner/ruderbar/issues/148) | append-only reversal events; collection hold on bank return — implemented by [#196](https://github.com/dgloeckner/clubbar/issues/196) |
...
| [#114 export silently omits](https://github.com/dgloeckner/ruderbar/issues/114) | Split across Phase 2 (reporting) and Phase 3 (cancelled-settlement guard) — **both halves shipped**, see Phase 2 |
