...
| Plan | Status | Summary |
|------|--------|---------|
| [Backend Test Coverage](./2026-08-07-backend-test-coverage.md) | Not Started (M0.1 done) | Issue #103 follow-up — raise PHPUnit line coverage from a measured 15.11% toward ADR-0022's 80%, starting with settlements/transactions (money), auth (security), members (GDPR) |
