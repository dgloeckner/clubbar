...
| Plan | Status | Summary |
|------|--------|---------|
| [IBAN Encryption (Sealed Boxes)](./2026-08-13-iban-encryption-sealed-box.md) | In Progress (P0 docs done; P1–P8 pending) | Epic [#388](https://github.com/dgloeckner/clubbar/issues/388) / [ADR-0035](../adr/0035-iban-encryption-sealed-box.md) + [ADR-0036](../adr/0036-mandate-documents-not-retained.md) — IBANs encrypted at rest with libsodium sealed boxes (server holds public key only; private key offline with the club, supplied per SEPA export/rotation behind TOTP step-up), 365-day key + terminal-token lifecycle with 90/30/7 warnings, last4-only API surfaces, mandate scans no longer retained |
